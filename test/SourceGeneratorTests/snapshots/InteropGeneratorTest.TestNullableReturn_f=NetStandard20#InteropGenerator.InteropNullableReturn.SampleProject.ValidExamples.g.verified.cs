//HintName: InteropGenerator.InteropNullableReturn.SampleProject.ValidExamples.g.cs
#nullable enable
namespace SampleProject.ValidExamples {
public partial class InteropNullableReturn
{
    ...
    public static partial FullyGenerated.TestWrapper? TestMethod()
    {
        ...
        __return_value = MMKiwi.CBindingSG.CbsgConstructionHelper.ConstructNullable<FullyGenerated.TestWrapper, FullyGenerated.TestHandle.Owns>(__return_value_raw);
